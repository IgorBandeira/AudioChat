  ...
  if (window.SpeechRecognition || window.webkitSpeechRecognition) {
    ...
    recognition.onresult = function (e) {
      ...
      for (var i = e.resultIndex; i < e.results.length; i++) {
        ...
        var primeiraLetra = resultado.charAt(0).toUpperCase();
        var restoTexto = resultado.slice(1).toLowerCase();
        var textoFinal = primeiraLetra + restoTexto + ".";

        document.getElementById("areatexto").innerHTML = textoFinal;
      }
    };
